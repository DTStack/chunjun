...
plugin_jars=`find $CHUNJUN_HOME -type f -maxdepth 2 | grep 'chunjun-' | grep '.jar'`
...
if [ "$1" = "help" ]; then
    ...
    export FLINK_CLASSPATH="$CHUNJUN_CLASSPATH:`constructFlinkClassPath`:$INTERNAL_HADOOP_CLASSPATHS"
