...
public class SqlRenameTableSingleton extends SqlCall {

    public static final SqlSpecialOperator OPERATOR =
            new SqlSpecialOperator("RENAME TABLE SINGLETON", SqlKind.OTHER_DDL);

    public SqlIdentifier oldName;
    public SqlIdentifier newName;

    public SqlRenameTableSingleton(SqlParserPos pos, SqlIdentifier oldName, SqlIdentifier newName) {
        super(pos);
