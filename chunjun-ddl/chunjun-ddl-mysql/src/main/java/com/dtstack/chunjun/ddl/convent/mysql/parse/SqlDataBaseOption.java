...
public class SqlDataBaseOption extends SqlCall {
    /** Use this operator only if you don't have a better one. */
    protected static final SqlOperator OPERATOR =
            new SqlSpecialOperator("DataBaseOption", SqlKind.OTHER);

    protected final SqlNode key;
    protected final SqlNode value;

    public SqlDataBaseOption(SqlParserPos pos, SqlNode key, SqlNode value) {
        super(pos);
