...
public class SqlCreateDataBase extends SqlCreate {
    ...
    public static final SqlSpecialOperator OPERATOR =
            new SqlSpecialOperator("CREATE DATABASE", SqlKind.CREATE_TABLE);
    ...
    public void unparse(SqlWriter writer, int leftPrec, int rightPrec) {
        ...
        if (dataBaseOptions != null && CollectionUtils.isNotEmpty(dataBaseOptions.getList())) {
            SqlWriter.Frame frame =
                    writer.startList(SqlWriter.FrameTypeEnum.create("sds"), "(", ")");
            for (SqlNode option : dataBaseOptions) {
