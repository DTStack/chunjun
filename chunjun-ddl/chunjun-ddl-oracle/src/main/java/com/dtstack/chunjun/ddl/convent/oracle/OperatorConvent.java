...
public interface OperatorConvent extends Serializable {
    public static final long serialVersionUID = 1L;

    String conventOperateDataBase(DataBaseOperator operator);

    List<String> conventOperateTable(TableOperator operator);

    List<String> conventOperateColumn(ColumnOperator operator);

    String conventOperateIndex(IndexOperator operator);

    String conventOperatorConstraint(ConstraintOperator operator);
