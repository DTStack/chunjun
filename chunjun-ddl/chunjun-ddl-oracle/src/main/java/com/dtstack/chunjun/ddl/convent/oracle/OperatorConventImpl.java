...
import com.dtstack.chunjun.ddl.convent.oracle.parse.SqlDropTable;
import com.dtstack.chunjun.ddl.convent.oracle.parse.SqlRenameTable;
import com.dtstack.chunjun.ddl.convent.oracle.parse.SqlTruncateTable;
import com.dtstack.chunjun.ddl.convent.oracle.util.OracleSqlNodeParseUtil;
...
public class OperatorConventImpl implements OperatorConvent, Serializable {
    private final ColumnTypeConvent columnTypeConvent = new OracleTypeConvent();
    ...
    @Override
    public List<String> conventOperateTable(TableOperator operator) {
        if (operator.getType().equals(EventType.DROP_TABLE)) {
            ...
            SqlRenameTable sqlRenameTable =
                    new SqlRenameTable(
                            SqlParserPos.ZERO,
                            SqlNodeUtil.conventTableIdentifierToSqlIdentifier(oldTableIdentifier),
                            SqlNodeUtil.conventTableIdentifierToSqlIdentifier(newTableIdentifier));
    ...
    @Override
    public List<String> conventOperateColumn(ColumnOperator operator) {
        ArrayList<String> sqls = new ArrayList<>();
        SqlIdentifier sqlIdentifier =
    ...
    @Override
    public String conventOperatorConstraint(ConstraintOperator operator) {
