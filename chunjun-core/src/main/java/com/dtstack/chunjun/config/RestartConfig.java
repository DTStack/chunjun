...
public class RestartConfig implements Serializable {
    ...
    public String toString() {
        return new StringJoiner(", ", RestartConfig.class.getSimpleName() + "[", "]")
                .add("strategy='" + strategy + "'")
                .add("restartAttempts=" + restartAttempts)
                .add("delayInterval=" + delayInterval)
                .add("failureRate=" + failureRate)
                .add("failureInterval=" + failureInterval)
                .toString();
    }
}
