...
public class SyncConfBuilder {
    ...
    private SyncConfBuilder() {
        this.syncConf = new SyncConf();
    }

    public SyncConfBuilder job(JobConf jobConf) {
        this.syncConf.setJob(jobConf);
        return this;
    }

    public SyncConf build() {
        return syncConf;
    }

    public SyncConfBuilder pluginRoot(String pluginRoot) {
        this.syncConf.setPluginRoot(pluginRoot);
        return this;
    }
}
