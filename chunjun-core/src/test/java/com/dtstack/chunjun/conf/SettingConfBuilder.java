...
public class SettingConfBuilder {
    ...
    private SettingConfBuilder() {
        this.settingConf = new SettingConf();
    }

    public SettingConfBuilder speed() {
        this.settingConf.setSpeed(new SpeedConf());
        return this;
    }

    public SettingConfBuilder speed(SpeedConf speedConf) {
        this.settingConf.setSpeed(speedConf);
        return this;
    }

    public SettingConf build() {
        return settingConf;
    }
}
