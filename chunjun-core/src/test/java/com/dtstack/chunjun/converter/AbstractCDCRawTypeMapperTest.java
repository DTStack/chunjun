...
public class AbstractCDCRawTypeMapperTest {
    ...
    public void wrapIntoNullableInternalConverterWhenInputIsNullThenReturnNull() throws Exception {
        AbstractCDCRawTypeMapper abstractCDCRawTypeMapper =
                PowerMockito.mock(AbstractCDCRawTypeMapper.class);
        IDeserializationConverter IDeserializationConverter =
                PowerMockito.mock(IDeserializationConverter.class);
        when(abstractCDCRawTypeMapper.wrapIntoNullableInternalConverter(IDeserializationConverter))
                .thenCallRealMethod();
        assertNull(
                abstractCDCRawTypeMapper
