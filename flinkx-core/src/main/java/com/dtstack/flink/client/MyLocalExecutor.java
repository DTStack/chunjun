...
package com.dtstack.flink.client;
 ...
 */
public class MyLocalExecutor extends PlanExecutor {
    ...
    public MyLocalExecutor() {
        this(null);
    }

    public MyLocalExecutor(Configuration conf) {
    ...
    public void endSession(JobID jobID) throws Exception {
        synchronized (MyLocalExecutor.class) {
    ...
    public static JobExecutionResult execute(Plan plan) throws Exception {
        return new MyLocalExecutor().executePlan(plan);
    }
