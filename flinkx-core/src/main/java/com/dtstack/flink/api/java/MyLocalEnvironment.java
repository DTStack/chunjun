...
import com.dtstack.flink.client.MyLocalExecutor;
 ...
 */
@Public
public class MyLocalEnvironment extends ExecutionEnvironment {

    /** The user-defined configuration for the local execution */
    private final Configuration configuration;

    /** Create lazily upon first use */
    private MyLocalExecutor executor;
     ...
     */
    public MyLocalEnvironment(Configuration config) {
