...
import static com.dtstack.flinkx.metrics.promethues.PrometheusPushGatewayReporterOptions.FILTER_LABEL_VALUE_CHARACTER;
...
public abstract class AbstractPrometheusReporter implements MetricReporter {
	...
	private static final String SCOPE_PREFIX = "flinkx" + SCOPE_SEPARATOR;
