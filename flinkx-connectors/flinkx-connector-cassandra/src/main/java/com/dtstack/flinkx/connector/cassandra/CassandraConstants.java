...
package com.dtstack.flinkx.connector.cassandra;
...
public class CassandraConstants {
    ...
    public static final String RANDOM_PARTITIONER = "RandomPartitioner";

    public static final String MURMUR3_PARTITIONER = "Murmur3Partitioner";
}
