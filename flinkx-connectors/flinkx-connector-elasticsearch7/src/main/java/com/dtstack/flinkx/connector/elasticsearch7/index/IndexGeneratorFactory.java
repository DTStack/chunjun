...
public class IndexGeneratorFactory {
	...
	/**
	 * Helper class for {@link org.apache.flink.streaming.connectors.elasticsearch.index.IndexGeneratorFactory}, this helper can use to validate index field type
