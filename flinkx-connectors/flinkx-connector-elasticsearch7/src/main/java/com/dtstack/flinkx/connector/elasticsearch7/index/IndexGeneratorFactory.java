...
public class IndexGeneratorFactory {
     ...
     * org.apache.flink.streaming.connectors.elasticsearch.index.IndexGeneratorFactory}, this helper
     * can use to validate index field type ans parse index format from pattern.
     */
