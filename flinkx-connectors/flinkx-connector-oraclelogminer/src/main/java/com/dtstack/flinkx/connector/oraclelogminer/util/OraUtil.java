 ...
 */
package com.dtstack.flinkx.connector.oraclelogminer.util;
    ...
    public static Pair<String, String> parseErrorMsg(String errorMsg){
        ...
        if(StringUtils.isNotBlank(errorMsg)){
            if(errorMsg.contains("ORA-01284")){
                pair = Pair.of("The file or directory may not exist or may be inaccessible or pathname exceeds 256 characters",
                        "Please ensure that the file and the directory exist and are accessible");
            }else if(errorMsg.contains("ORA-01013")){
                pair = Pair.of("sql is timeout when query data from logMiner",
                ...
                pair = Pair.of("too many Oracle archive logs queried",
                ...
                pair = Pair.of("This simply means that something in the backend ( DBMS ) decided to stop working due to unavailability of resources etc",
                ...
                pair = Pair.of("The archived log was out of sequence, probably because it was corrupt or the wrong redo log file name was specified during recovery",
                ...
                pair = Pair.of("This simply means that the logfile specified has already been added to the list of logfiles and it may be we find same logfile ",
                ...
                pair = Pair.of("This simply means that if your Oracle version is 11.1, Oracle will scan or dump the redo records within 12 hours. If it is found that the required redo records have been deleted in the scan or dump, ora-00308 and ora-27037 errors will be reported.  ",
