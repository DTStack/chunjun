...
public class PGWalDynamicTableFactoryTest {
    ...
    public void testStartStream() throws TableNotExistException {
        ...
        String catalogName = (String) getOptionByName(dynamicTableFactory.requiredOptions(), "catalog");
        String defaultDatabase = (String) getOptionByName(dynamicTableFactory.requiredOptions(), "database");
        String username = (String) getOptionByName(dynamicTableFactory.requiredOptions(), "username");
        ...
        AbstractJdbcCatalog catalog = JdbcCatalogUtils.createCatalog(catalogName, defaultDatabase, username, pwd, baseUrl);
...
//        environment.from()
    ...
    private Object getOptionByName(Set<ConfigOption<?>> optionSet, String name) {
        ...
        return optionSet.stream().filter(option -> option.key().equals(name)).findAny().get().defaultValue();
    }
}
