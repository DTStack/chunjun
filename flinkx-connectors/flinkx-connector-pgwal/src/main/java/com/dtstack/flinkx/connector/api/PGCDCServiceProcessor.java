...
public class PGCDCServiceProcessor
        extends DatabaseBaseRichInputFormat<RowData, RowData, RowData>
        implements ServiceProcessor<RowData, RowData> {

    private static final Logger LOG = LoggerFactory.getLogger(PGCDCServiceProcessor.class);
    ...
    public PGCDCServiceProcessor(Map<String, Object> config) {
        super(config);
    }

    public PGCDCServiceProcessor() {
        super(new HashMap<>());
    }
