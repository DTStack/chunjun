 ...
 */
package com.dtstack.flinkx.connector.hbase.source;
...
import com.dtstack.flinkx.connector.hbase.converter.HBaseRawTypeConverter;
...
public class HbaseSourceFactory extends SourceFactory {

    private static final Logger LOG = LoggerFactory.getLogger(HbaseSourceFactory.class);

    private final HBaseConf config;

    public HbaseSourceFactory(SyncConf syncConf, StreamExecutionEnvironment env) {
        super(syncConf, env);
        config =
