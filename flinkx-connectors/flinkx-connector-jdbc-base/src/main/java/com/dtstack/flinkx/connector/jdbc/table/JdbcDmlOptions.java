...
public class JdbcDmlOptions extends JdbcTypedQueryOptions {
    ...
    public static JdbcDmlOptions.JdbcDmlOptionsBuilder builder() {
        return new JdbcDmlOptions.JdbcDmlOptionsBuilder();
    }
    ...
    public static class JdbcDmlOptionsBuilder
            extends JdbcUpdateQueryOptionsBuilder<JdbcDmlOptions.JdbcDmlOptionsBuilder> {
        ...
        @Override
        protected JdbcDmlOptions.JdbcDmlOptionsBuilder self() {
            return this;
        }

        public JdbcDmlOptions.JdbcDmlOptionsBuilder withFieldNames(String field, String... fieldNames) {
            this.fieldNames = concat(field, fieldNames);
            return this;
        }

        public JdbcDmlOptions.JdbcDmlOptionsBuilder withFieldNames(String[] fieldNames) {
            this.fieldNames = fieldNames;
            return this;
        }

        public JdbcDmlOptions.JdbcDmlOptionsBuilder withKeyFields(String keyField, String... keyFields) {
            this.keyFields = concat(keyField, keyFields);
            return this;
        }

        public JdbcDmlOptions.JdbcDmlOptionsBuilder withKeyFields(String[] keyFields) {
            this.keyFields = keyFields;
            return this;
        }

        public JdbcDmlOptions.JdbcDmlOptionsBuilder withTableName(String tableName) {
            this.tableName = tableName;
            return self();
        }

        public JdbcDmlOptions.JdbcDmlOptionsBuilder withDialect(JdbcDialect dialect) {
