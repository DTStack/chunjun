...
package com.dtstack.flinkx.connector.es.table;
...
import com.dtstack.flinkx.connector.es.sink.EsDynamicTableSink;
import com.dtstack.flinkx.connector.es.source.EsDynamicTableSource;
...
public class EsDynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        return new EsDynamicTableSink(physicalSchema, getElasticsearchConf(config, physicalSchema));
    }
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        return new EsDynamicTableSource(physicalSchema,
    ...
    private EsConf getElasticsearchConf(ReadableConfig readableConfig, TableSchema schema) {
        EsConf elasticsearchConf = new EsConf();
