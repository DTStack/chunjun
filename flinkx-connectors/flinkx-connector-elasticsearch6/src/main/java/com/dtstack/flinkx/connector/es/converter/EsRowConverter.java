 ...
 */
public class EsRowConverter extends AbstractRowConverter<Map<String, Object>, Map<String, Object>, Map<String, Object>, LogicalType> {

    private static final long serialVersionUID = 2L;

    private Logger LOG = LoggerFactory.getLogger(EsRowConverter.class);
    private List<Tuple3<String,Integer, LogicalType>> typeIndexList = new ArrayList<>();

    public EsRowConverter(RowType rowType) {
        super(rowType);
