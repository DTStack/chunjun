...
import com.dtstack.flinkx.connector.elasticsearch6.conf.ElasticsearchConf;
import com.dtstack.flinkx.connector.elasticsearch6.sink.ElasticsearchDynamicTableSink;
import com.dtstack.flinkx.connector.elasticsearch6.source.ElasticsearchDynamicTableSource;
...
import static com.dtstack.flinkx.connector.elasticsearch6.options.DtElasticsearchOptions.DT_BULK_FLUSH_MAX_ACTIONS_OPTION;
import static com.dtstack.flinkx.connector.elasticsearch6.utils.ElasticsearchConstants.IDENTIFIER;
...
public class ElasticsearchDynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        return new ElasticsearchDynamicTableSink(physicalSchema, getElasticsearchConf(config, physicalSchema));
    }
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        return new ElasticsearchDynamicTableSource(physicalSchema,
    ...
    private ElasticsearchConf getElasticsearchConf(ReadableConfig readableConfig, TableSchema schema) {
