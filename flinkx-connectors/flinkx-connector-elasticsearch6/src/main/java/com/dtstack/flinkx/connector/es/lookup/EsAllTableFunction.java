...
package com.dtstack.flinkx.connector.es.lookup;
 ...
 */
public class EsAllTableFunction extends AbstractAllTableFunction {

    private static final long serialVersionUID = 2L;
    private static Logger LOG = LoggerFactory.getLogger(EsLruTableFunction.class);

    private final EsConf elasticsearchConf;
    private transient RestHighLevelClient rhlClient;

    public EsAllTableFunction(
    ...
    private SearchRequest buildSearchRequest() {
        SearchSourceBuilder sourceBuilder = EsRequestHelper.createSourceBuilder(
                fieldsName,
                null,
                null);
        sourceBuilder.size(lookupConf.getFetchSize());

        return EsRequestHelper.createSearchRequest(
