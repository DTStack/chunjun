      ...
      <div className="h-[558px] items-center flex flex-col md:flex-row justify-center">
        <div className="h-full w-full flex justify-center items-center bg-block dark:bg-none bg-contain bg-center bg-no-repeat">
          <Card component="a" className="left__cards--card bg-transparent">
            ...
            <Text size="sm" className="left__cards--text   dark:text-white ">
              在这里你可以获取到最新的技术及产品知识
            </Text>
          </Card>
        </div>
        <div className="h-full  dark:bg-none bg-block2  bg-no-repeat bg-center bg-contain w-full flex justify-center items-center">
          <div className="flex md:space-x-12 space-x-6">
            <div>
              <h3 className="mb-[20px] dark:text-white">文档</h3>
            ...
            <div>
              <h3 className="mb-[20px] dark:text-white">更多</h3>
              <ul className="flex flex-col space-y-2">
