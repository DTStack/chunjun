...
import com.dtstack.flinkx.kafka.decoder.IDecode;
import com.dtstack.flinkx.kafka.decoder.JsonDecoder;
import com.dtstack.flinkx.kafka.decoder.PlainDecoder;
...
public class KafkaConsumer {
    ...
    public KafkaConsumer createClient(String topic, String group, KafkaInputFormat format) {
    ...
    public static class Client implements Runnable {
        ...
        public Client(Properties clientProps, List<String> topics, long pollTimeout, KafkaInputFormat format) {
