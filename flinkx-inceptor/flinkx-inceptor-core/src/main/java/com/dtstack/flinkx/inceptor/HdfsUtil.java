...
package com.dtstack.flinkx.inceptor;
...
public class HdfsUtil {
    ...
    public static ObjectInspector columnTypeToObjectInspetor(ColumnType columnType) {
        ...
        switch(columnType) {
            case TINYINT:
                objectInspector = ObjectInspectorFactory.getReflectionObjectInspector(ByteWritable.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
                break;
            case SMALLINT:
                objectInspector = ObjectInspectorFactory.getReflectionObjectInspector(ShortWritable.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
                break;
            case INT:
            ...
            case FLOAT:
                ...
                break;
            case DOUBLE:
                objectInspector = ObjectInspectorFactory.getReflectionObjectInspector(org.apache.hadoop.hive.serde2.io.DoubleWritable.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
                break;
            case DECIMAL:
            ...
            case TIMESTAMP:
                ...
                break;
            case DATE:
                objectInspector = ObjectInspectorFactory.getReflectionObjectInspector(DateWritable.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
                break;
            case STRING:
            case CHAR:
                ...
                break;
            case VARCHAR2:
                objectInspector = ObjectInspectorFactory.getReflectionObjectInspector(HiveVarchar2Writable.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
                break;
            case VARCHAR:
                objectInspector = ObjectInspectorFactory.getReflectionObjectInspector(HiveVarcharWritable.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
                break;
            case BOOLEAN:
