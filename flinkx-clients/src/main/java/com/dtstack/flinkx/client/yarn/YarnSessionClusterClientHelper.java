...
public class YarnSessionClusterClientHelper implements ClusterClientHelper {
        ...
        try {
            ...
            try (YarnClient yarnClient = YarnClient.createYarnClient()) {
                ...
                try(YarnClusterDescriptor yarnClusterDescriptor = new YarnClusterDescriptor(
                        ...
                        true)) {
                    ClusterClient clusterClient = yarnClusterDescriptor.retrieve(applicationId).getClusterClient();
    ...
    private ApplicationId getAppIdFromYarn(YarnClient yarnClient, Options launcherOptions) throws Exception{
