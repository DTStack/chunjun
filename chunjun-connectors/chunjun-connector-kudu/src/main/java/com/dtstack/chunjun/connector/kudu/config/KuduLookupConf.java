...
public class KuduLookupConf extends LookupConfig {
    ...
    public KuduCommonConfig getCommonConf() {
        return commonConfig;
    }

    public void setCommonConf(KuduCommonConfig commonConfig) {
    ...
    public static KuduLookupConf from(ReadableConfig readableConfig) {
        ...
        conf.setCommonConf(kuduCommonConfig);
