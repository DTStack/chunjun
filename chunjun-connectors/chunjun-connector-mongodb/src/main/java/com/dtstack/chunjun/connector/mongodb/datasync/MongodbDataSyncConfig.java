...
public class MongodbDataSyncConfig extends CommonConfig implements Serializable {
    ...
    public String toString() {
        return new StringJoiner(", ", MongodbDataSyncConfig.class.getSimpleName() + "[", "]")
                ...
                .add("monitorDatabases=" + monitorDatabases)
                .add("monitorCollections=" + monitorCollections)
                .add("clusterMode='" + clusterMode + "'")
                .add("startLocation=" + startLocation)
                .add("excludeDocId=" + excludeDocId)
                .add("mongodbConfig=" + mongodbConfig)
                .toString();
    }
}
