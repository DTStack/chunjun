...
import static com.dtstack.chunjun.connector.kafka.sink.DynamicKafkaRecordSerializationSchema.createProjectedRow;
...
class ReducingUpsertWriter<WriterState>
     ...
     *
     * <p>When records arrives, the {@link ReducingUpsertWriter} updates the current {@link Context}
     * and memorize the timestamp with the records. When flushing, the {@link ReducingUpsertWriter}
     * will emit the records in the buffer with memorized timestamp.
     */
