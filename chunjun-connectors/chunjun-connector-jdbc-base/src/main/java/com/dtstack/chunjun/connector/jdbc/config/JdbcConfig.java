...
public class JdbcConfig extends CommonConfig implements Serializable {
    ...
    public String toString() {
        return new StringJoiner(", ", JdbcConfig.class.getSimpleName() + "[", "]")
                ...
                .add("insertSqlMode='" + insertSqlMode + "'")
                .add("fieldDelim='" + fieldDelim + "'")
                .add("nullDelim='" + nullDelim + "'")
                .add("withNoLock=" + withNoLock)
                ...
                .add("orderByColumn='" + orderByColumn + "'")
                .add("querySql='" + querySql + "'")
                .add("splitPk='" + splitPk + "'")
                .add("splitStrategy='" + splitStrategy + "'")
                .add("fetchSize=" + fetchSize)
                .add("queryTimeOut=" + queryTimeOut)
                .add("connectTimeOut=" + connectTimeOut)
                .add("increment=" + increment)
                .add("polling=" + polling)
                .add("pollingFromMax=" + pollingFromMax)
                .add("increColumn='" + increColumn + "'")
                .add("isOrderBy=" + isOrderBy)
                .add("increColumnIndex=" + increColumnIndex)
                .add("increColumnType='" + increColumnType + "'")
                .add("startLocation='" + startLocation + "'")
                .add("pollingInterval=" + pollingInterval)
                .add("restoreColumn='" + restoreColumn + "'")
                .add("restoreColumnType='" + restoreColumnType + "'")
                .add("restoreColumnIndex=" + restoreColumnIndex)
                .add("useMaxFunc=" + useMaxFunc)
                .add("initReporter=" + initReporter)
                .add("mode='" + mode + "'")
                .add("preSql=" + preSql)
                .add("postSql=" + postSql)
