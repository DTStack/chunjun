...
public class StatementWrapperUtil {
    ...
    public static JdbcBatchStatementWrapper<RowData> buildInsertDeleteExecutor(
            ...
            throws SQLException {
        Tuple3<String, String, String> tableIdentify = jdbcDialect.getTableIdentify(schema, table);
        String catalog = tableIdentify.f0;
        schema = tableIdentify.f1;
        table = tableIdentify.f2;
        List<String> columnNameList = getSelectedNameColumnList(columnRowData);
        List<String> columnTypeList =
                getColumnTypeFromMetadata(connection, catalog, schema, table, columnNameList);
    ...
    public static List<String> getColumnTypeFromMetadata(
        ...
        try {
            Pair<List<String>, List<String>> tableMetaData =
                    JdbcUtil.getTableMetaData(catalog, schema, table, connection);
