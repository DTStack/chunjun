...
public class ArcticColumnConverter extends AbstractRowConverter<RowData, RowData, String, String> {

    private List<String> columnNameList;
    private transient Map<String, ColumnTypeUtil.DecimalInfo> decimalColInfo;

    public ArcticColumnConverter(List<FieldConfig> fieldConfList) {
