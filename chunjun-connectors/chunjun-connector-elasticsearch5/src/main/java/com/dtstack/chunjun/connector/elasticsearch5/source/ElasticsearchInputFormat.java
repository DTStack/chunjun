...
import com.dtstack.chunjun.connector.elasticsearch5.utils.ElasticsearchRequestHelper;
import com.dtstack.chunjun.connector.elasticsearch5.utils.ElasticsearchUtil;
import com.dtstack.chunjun.exception.ReadRecordException;
import com.dtstack.chunjun.inputformat.BaseRichInputFormat;
    ...
    private boolean searchScroll() {
        ...
        if (scrollId == null) {
            SearchResponse searchResponse =
                    client.search(searchRequest).actionGet(elasticsearchConf.getActionTimeout());
            ...
            SearchResponse searchResponse =
                    client.searchScroll(scrollRequest)
                            .actionGet(elasticsearchConf.getActionTimeout());
            scrollId = searchResponse.getScrollId();
            searchHits = searchResponse.getHits().getHits();
        }
