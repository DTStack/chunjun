...
public class ElasticsearchRequestHelper {
    ...
    public static UpdateRequest createUpdateRequest(
            String index, String type, String id, Map<String, Object> dataMap) {
        return new UpdateRequest(index, type, id).doc(dataMap).upsert(dataMap);
    }
    ...
    public static IndexRequest createIndexRequest(
            String index, String type, Map<String, Object> dataMap) {
        return new IndexRequest(index, type).source(dataMap);
    }
     ...
     * @return
     */
    public static DeleteRequest createDeleteRequest(String index, String type, String id) {
