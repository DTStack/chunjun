...
public class NebulaDynamicTableSink implements DynamicTableSink {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NebulaDynamicTableSink.class);
    ...
    public NebulaDynamicTableSink(
            TableSchema tableSchema, NebulaConf nebulaConf, NebulaOutputFormatBuilder builder) {
