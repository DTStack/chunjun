...
<br />jdbcUrl参考文档：[db2官方文档](https://www.ibm.com/support/knowledgecenter/en/SSEPGG_11.1.0/com.ibm.db2.luw.apdv.java.doc/src/tpc/imjcc_rjv00004.htmlId=t14:12:14)
  - 必选：是
  - 默认值：无
    ...
    "content": [{
      "reader": {
        "parameter" : {
          ...
          "fetchSize": 1000,
          "queryTimeOut": 1000,
          "customSql":"select id, name from staff where id > 300",
          "requestAccumulatorInterval": 2
        },
        "name" : "db2reader"
      },
