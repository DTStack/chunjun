...
- **jdbcUrl**
  - 描述：针对关系型数据库的jdbc连接字符串，需要注意gbase有A、S、T三种发行版，jdbcUrl端口和驱动都有区别。<br />jdbcUrl参考文档：[gbase官方文档](https://help.finereport.com/doc-view-2569.html)
  - 必选：是
  - 默认值：无
    ...
    "content": [{
      "reader": {
        "parameter" : {
          ...
          "fetchSize": 1000,
          "queryTimeOut": 1000,
          "customSql": "select id, user_id, name from tableTest where id > 20",
          "requestAccumulatorInterval": 2
        },
        "name" : "gbasereader"
      },
